...
const ServicesData = [
    {
        ...
        'description': 'Crowns and bridge treatment are common dental procedures that address various dental issues, such as damaged or missing teeth. They are designed to restore your teeth’ appearance, function, and strength while enhancing oral health.',
    },
    {
        'icon': iconTwo,
        'title': 'Implants',
